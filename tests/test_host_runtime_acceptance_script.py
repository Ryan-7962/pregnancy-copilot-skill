...
def test_host_runtime_acceptance_covers_host_contract(tmp_path):
    ...
    assert result["checks"]["general_chat_not_handled"] is True
    ...
    assert result["checks"]["general_chat_host_action_pass_through"] is True
    assert result["checks"]["general_chat_writes_no_memory"] is True
    assert result["host_contract"]["general_chat"]["handled"] is False
    assert result["host_contract"]["general_chat"]["host_action_type"] == "pass_through"
